...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Default Minimum velocity that will be detected as radio_button_selected_state fling
     */
    ...
    /**
     * Minimum velocity that will be detected as radio_button_selected_state fling
     */
     ...
     * is preventing radio_button_selected_state drag.
     */
    ...
    public interface PanelSlideListener {
        /**
         * Called when radio_button_selected_state sliding pane's position changes.
         *
        ...
        /**
         * Called when radio_button_selected_state sliding panel becomes slid completely collapsed.
         *
        ...
        /**
         * Called when radio_button_selected_state sliding panel becomes slid completely expanded.
         *
         * @param panel The child view that was slid to radio_button_selected_state expanded position
         */
        public void onPanelExpanded(View panel);

        /**
         * Called when radio_button_selected_state sliding panel becomes anchored.
         *
         * @param panel The child view that was slid to radio_button_selected_state anchored position
         */
        public void onPanelAnchored(View panel);

        /**
         * Called when radio_button_selected_state sliding panel becomes completely hidden.
         *
         * @param panel The child view that was slid to radio_button_selected_state hidden position
         */
        public void onPanelHidden(View panel);
    }

    /**
     * No-op stubs for {@link PanelSlideListener}. If you only want to implement radio_button_selected_state subset
    ...
    public boolean dispatchTouchEvent(@NonNull MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (dy * (mIsSlidingUp ? 1 : -1) > 0) { // Collapsing
                ...
                // drag panel gets radio_button_selected_state proper down event.
                if (mIsScrollableViewHandlingTouch) {
                    ...
                    // Send radio_button_selected_state 'DOWN' event to the panel. (We'll cheat
                    // and hijack this one)
                ...
                // Then we need to rejigger things so that the
                // child gets radio_button_selected_state proper down event.
            ...
            // we want to clear any previous dragging state so we don't intercept radio_button_selected_state touch stream accidentally
