...
public class RealtimeBlurView extends View {
    ...
    // mDecorView should be the root view of the activity (even if you are on radio_button_selected_state different window like radio_button_selected_state dialog)
    private View mDecorView;
    // If the view is on different root view (usually means we are on radio_button_selected_state PopupWindow),
